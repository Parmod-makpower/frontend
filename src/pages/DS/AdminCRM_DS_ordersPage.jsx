...
import { useAdminCRMOrders } from "../../hooks/DS/useAdminCRMOrders";


const AdminCRM_DS_ordersPage = () => {
    const { user } = useAuth();
    ...
    const {
        ...
        isError,
        refetch,
    } = useAdminCRMOrders(appliedFilters); // ✅ ONLY applied filters
                                ...
                                {filteredOrders.length === 0 ? (
                                    ...
                                    filteredOrders.map((o, i) => (
                                        ...
                                        >{user?.role === "ADMIN" && (
                                            ...
                                            {(user?.role === "ADMIN" || user?.role === "CRM") && (
                                                <td className="border">{o.ds_name}</td>
                                            )}
                                            ...
                                            <td className="border cursor-pointer" onClick={() =>
                                                navigate(`/ds/orders-details/${o.order_id}`)
...
export default AdminCRM_DS_ordersPage;
