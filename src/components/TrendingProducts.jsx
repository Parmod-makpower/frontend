...
import { FaShoppingCart, FaGift, FaCheckCircle, FaTimesCircle, FaPlus, FaMinus, FaFire } from "react-icons/fa";
...
export default function TrendingProducts({ trendingIds = [] }) {
  ...
  if (!trendingProducts.length) {
    return <p className="text-gray-500 text-sm">No trending products found.</p>;
  }
