...
export default function DispatchPDF(
  ...
  doc.text(
    `Order At: ${new Date(order.ss_order_created_at).toLocaleString(
      "en-IN",
  ...
  doc.rect(boxX, boxY, boxWidth, infoBoxHeight, "F");
  ...
  autoTable(doc, {
    ...
    head: [
      ["S.N", "Category", "Product Name", "Qty", "Rack", "Carton", "Stock"]
    ],
